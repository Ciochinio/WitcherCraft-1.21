...
@EventBusSubscriber
public class AxiiGlowProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		if (entity instanceof LivingEntity _livEnt0 && _livEnt0.hasEffect(WitchercraftModMobEffects.AXII_SIGN) && entity.getData(WitchercraftModVariables.PLAYER_VARIABLES).witchercraftSignKeyHoldTime != 0
			...
			if ((findEntityInWorldRange(world, Mob.class,
				...
				_entity.addEffect(new MobEffectInstance(MobEffects.GLOWING, 3, 1, false, false));
		}
	}
