...
public class SignGuiScreen extends AbstractContainerScreen<SignGuiMenu> {
	private final static HashMap<String, Object> guistate = SignGuiMenu.guistate;
	...
	public void init() {
		...
		guistate.put("button:button_yrden", button_yrden);
		...
		guistate.put("button:button_quen", button_quen);
		...
		guistate.put("button:button_igni", button_igni);
		...
		guistate.put("button:button_axii", button_axii);
		...
		guistate.put("button:button_aard", button_aard);
