...
public class CharacterAbilitiesCombatGuiScreen extends AbstractContainerScreen<CharacterAbilitiesCombatGuiMenu> {
	private final static HashMap<String, Object> guistate = CharacterAbilitiesCombatGuiMenu.guistate;
	...
	public void init() {
		...
		guistate.put("button:imagebutton_muslememory", imagebutton_muslememory);
		...
		guistate.put("button:imagebutton_preciseblows", imagebutton_preciseblows);
		...
		guistate.put("button:imagebutton_cripplingstrikes", imagebutton_cripplingstrikes);
		...
		guistate.put("button:imagebutton_strengthtraining", imagebutton_strengthtraining);
		...
		guistate.put("button:imagebutton_crushingblows", imagebutton_crushingblows);
		...
		guistate.put("button:imagebutton_sunderarmor", imagebutton_sunderarmor);
		...
		guistate.put("button:imagebutton_fleetfooted", imagebutton_fleetfooted);
		...
		guistate.put("button:imagebutton_defense", imagebutton_defense);
		...
		guistate.put("button:imagebutton_deadlyprecision", imagebutton_deadlyprecision);
		...
		guistate.put("button:imagebutton_coldblood", imagebutton_coldblood);
		...
		guistate.put("button:imagebutton_anatomicalknowledge", imagebutton_anatomicalknowledge);
		...
		guistate.put("button:imagebutton_cripplingshot", imagebutton_cripplingshot);
		...
		guistate.put("button:imagebutton_floodofanger", imagebutton_floodofanger);
		...
		guistate.put("button:imagebutton_razorfocus", imagebutton_razorfocus);
		...
		guistate.put("button:imagebutton_undying", imagebutton_undying);
