...
public class BestiaryMenuGuiScreen extends AbstractContainerScreen<BestiaryMenuGuiMenu> {
	private final static HashMap<String, Object> guistate = BestiaryMenuGuiMenu.guistate;
