...
public class CharactersAbilietesGeneralGuiScreen extends AbstractContainerScreen<CharactersAbilietesGeneralGuiMenu> {
	private final static HashMap<String, Object> guistate = CharactersAbilietesGeneralGuiMenu.guistate;
	...
	public void init() {
		...
		guistate.put("button:imagebutton_sunandstars", imagebutton_sunandstars);
		...
		guistate.put("button:imagebutton_survivalinstict", imagebutton_survivalinstict);
		...
		guistate.put("button:imagebutton_catschooltechniques", imagebutton_catschooltechniques);
		...
		guistate.put("button:imagebutton_griffinschool", imagebutton_griffinschool);
		...
		guistate.put("button:imagebutton_bearschool", imagebutton_bearschool);
