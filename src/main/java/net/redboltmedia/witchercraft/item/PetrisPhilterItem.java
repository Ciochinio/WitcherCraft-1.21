...
import net.redboltmedia.witchercraft.procedures.PetrisPhilterUsedProcedure;
...
public class PetrisPhilterItem extends Item {
	public PetrisPhilterItem(Item.Properties properties) {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		PetrisPhilterUsedProcedure.execute(entity);
		return retval;
	}
}