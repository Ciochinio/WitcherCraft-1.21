...
import net.redboltmedia.witchercraft.procedures.BlizzardUsedProcedure;
...
public class BlizzardItem extends Item {
	public BlizzardItem(Item.Properties properties) {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		BlizzardUsedProcedure.execute(entity);
		return retval;
	}
}